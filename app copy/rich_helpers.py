...
def print_info(console: Console, video: Path, all_videos_list: list[Path], remaining_videos_list: list[Path], dst: str) -> None:
    ...
    processed_size = Text.assemble(("Transcoded Size: ", "yellow"), f"{get_total_size(get_videos(Path(dst)))}MB")
